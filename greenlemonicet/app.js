...
/* ============================================================
   NEUE STYLES FÜR DIE ERWEITERTEN SEITEN (Pfeiler, Blasen,
   Chat, Quiz, Sternenhimmel, Buch-Sektion)
   ============================================================ */
...
.chat-question::-webkit-details-marker {
  display: none;
}
.chat-icon {
  width: 40px;
...
/* Abstände für bestimmte Abschnitte */
#teil1 {
  padding-top: 6rem;
}
#dialog {
...
.sky-container {
  ...
  background-image:
    ...
    radial-gradient(2px 2px at 90% 50%, rgba(255,255,255,0.1), transparent),
...
.star {
  ...
  align-items: center;
  justify-content: center;
  transform: translate(-50%, -50%); /* Zentriert auf den Koordinatenpunkt */
...
/* Finale Farbanpassung: Seher = Mintgrün, Bewahrer = Pastellorange */
.star.sehend i {
  color: #A8E6CF;
  text-shadow: 0 0 10px rgba(168, 230, 207, 0.8), 0 0 20px rgba(168, 230, 207, 0.5);
  animation: flackerSehend 3s ease-in-out infinite;
}
.star.bewahrend i {
  color: #F5B07F;
  text-shadow: 0 0 10px rgba(245, 176, 127, 0.8), 0 0 20px rgba(245, 176, 127, 0.5);
  animation: flackerBewahrend 2s linear infinite;
}
@keyframes flackerSehend {
  0%, 100% { opacity: 1; }
  25% { opacity: 0.8; }
  50% { opacity: 0.6; }
  75% { opacity: 0.9; }
}
@keyframes flackerBewahrend {
  0%, 100% { opacity: 1; }
  50% { opacity: 0.7; }
}
...
.stern-modal {
  ...
  overflow-y: auto;
  border: 1px solid #A8E6CF;
  border-left: 3px solid transparent;   /* wird je nach Typ gesetzt */
  box-shadow: 0 0 40px rgba(0,0,0,0.7);
  position: relative;
}
.stern-modal-close {
...
.stern-modal-close:hover {
  color: #FFFFFF;
}
.stern-modal h3 {
  font-family: 'Inter Tight', sans-serif;
  font-size: 1.6rem;
  margin-bottom: 0;                 /* wichtig für den Header-Flex */
  padding-right: 2rem;
}
.stern-modal p {
  color: #B0B0B0;
...
/* Porträt im Modal */
.stern-modal-portrait {
  width: 60px;
  height: 60px;
  border-radius: 50%;
  border: 2px solid transparent;   /* wird je nach Typ gesetzt */
  display: flex;
  align-items: center;
  justify-content: center;
  overflow: hidden;
...
/* NEU: Header-Container für Porträt und Name */
.stern-modal-header {
  display: flex;
  align-items: center;
  gap: 1rem;
...
/* Typ-Seher – Mintgrün */
.stern-modal.modal-seher {
  border-left-color: #A8E6CF;
}
.stern-modal.modal-seher .stern-modal-portrait {
  border-color: #A8E6CF;
  box-shadow: 0 0 8px rgba(168, 230, 207, 0.4);
}
.stern-modal.modal-seher h3,
.stern-modal.modal-seher #sternQuote {
  color: #A8E6CF;
  border-left-color: #A8E6CF;
}

/* Typ-Bewahrer – Pastellorange */
.stern-modal.modal-bewahrer {
  border-left-color: #F5B07F;
}
.stern-modal.modal-bewahrer .stern-modal-portrait {
  border-color: #F5B07F;
  box-shadow: 0 0 8px rgba(245, 176, 127, 0.4);
}
.stern-modal.modal-bewahrer h3,
.stern-modal.modal-bewahrer #sternQuote {
  color: #F5B07F;
  border-left-color: #F5B07F;
}

/* Farbliche Hervorhebung im Sternenhimmel-Text */
.seher {
  color: #A8E6CF;
  text-shadow: 0 0 20px rgba(168, 230, 207, 0.2);
}
.bewahrer {
  color: #F5B07F;
  text-shadow: 0 0 20px rgba(245, 176, 127, 0.2);
}
...
@media (max-width: 600px) {
  ...
  .sky-container {
    height: 70vh; /* Auch auf Mobil begrenzt */
  }
  .star {
    width: 24px;
    height: 24px;
